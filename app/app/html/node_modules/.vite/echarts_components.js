...
var CalendarView = function(_super) {
  ...
  CalendarView2.prototype._renderMonthText = function(calendarModel, orient, group) {
  ...
  CalendarView2.prototype._renderWeekText = function(calendarModel, rangeData, orient, group) {
...
var TooltipHTMLContent = function() {
  ...
  TooltipHTMLContent2.prototype.show = function(tooltipModel, nearPointColor) {
    ...
    if (!el.innerHTML) {
      ...
      style.cssText = gCssText + assembleCssText(tooltipModel, !this._firstShow, this._longHide) + assembleTransform(styleCoord[0], styleCoord[1], true) + ("border-color:" + convertToColorString(nearPointColor) + ";") + (tooltipModel.get("extraCssText") || "") + (";pointer-event:" + (this._enterable ? "auto" : "none"));
    }
    this._show = true;
  ...
  TooltipHTMLContent2.prototype.getOuterSize = function() {
...
var TooltipRichContent = function() {
  ...
  TooltipRichContent2.prototype.getOuterSize = function() {
...
var TooltipView = function(_super) {
  ...
  TooltipView2.prototype._updateContentNotChangedOnAxis = function(dataByCoordSys) {
...
var TimelineModel = function(_super) {
  ...
  TimelineModel2.prototype._initData = function() {
    ...
    var data = this._data = new List_default([{
      name: "value",
      type: dimType
    }], this);
...
function giveSymbol(hostModel, itemStyleModel, group, opt, symbol, callback) {
  ...
  if (symbolOffset) {
    opt.x = opt.x || 0;
    opt.y = opt.y || 0;
    opt.x += parsePercent2(symbolOffset[0], symbolSize[0]);
    opt.y += parsePercent2(symbolOffset[1], symbolSize[1]);
  }
...
function createList(coordSys, seriesModel, mpModel) {
  ...
  var mpData = new List_default(coordDimsInfos, mpModel);
...
function createList2(coordSys, seriesModel, mlModel) {
  ...
  var fromData = new List_default(coordDimsInfos, mlModel);
  var toData = new List_default(coordDimsInfos, mlModel);
  var lineData = new List_default([], mlModel);
  var optData = map(mlModel.get("data"), curry(markLineTransform, seriesModel, coordSys, mlModel));
  if (coordSys) {
    optData = filter(optData, curry(markLineFilter, coordSys));
  }
  var dimValueGetter2 = coordSys ? dimValueGetter : function(item) {
    return item.value;
  };
...
function createList3(coordSys, seriesModel, maModel) {
  ...
  if (coordSys) {
    ...
    areaData = new List_default(map(dims, function(dim, idx) {
      return {
        name: dim,
  ...
  var dimValueGetter2 = coordSys ? function(item, dimName, dataIndex, dimIndex) {
...
var VisualMapModel = function(_super) {
  ...
  VisualMapModel2.prototype.getDataDimension = function(list) {
