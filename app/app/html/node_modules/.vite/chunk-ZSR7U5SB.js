...
function completeDimensions(sysDims, source, opt) {
  ...
  for (var i = 0; i < dimCount; i++) {
    ...
    var resultItem = result[i] = new DataDimensionInfo_default();
  ...
  for (var resultDimIdx = 0; resultDimIdx < dimCount; resultDimIdx++) {
    var resultItem = result[resultDimIdx] = result[resultDimIdx] || new DataDimensionInfo_default();
...
var completeDimensions_default = completeDimensions;
...
function createListFromArray(source, seriesModel, opt) {
  ...
  var list = new List_default(dimInfoList, seriesModel);
...
//# sourceMappingURL=chunk-ZSR7U5SB.js.map
