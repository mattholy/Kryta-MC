import {
  createDimensions,
  createListFromArray_default
} from "./chunk-ZSR7U5SB.js";
import {
  LineDraw_default,
...
function getVisualGradient(data, coordSys) {
  ...
  var gradient = new LinearGradient_default(0, 0, 0, 0, colorStops, true);
...
var LineView = function(_super) {
  ...
  LineView2.prototype.dispose = function() {
  };
      ...
      return dimLen && {
        progress: function(params, data2) {
          ...
          for (var i = params.start, offset = 0; i < params.end; i++) {
            var point = void 0;
            if (dimLen === 1) {
              var x = data2.getByDimIdx(dimIdx0, i);
              point = coordSys.dataToPoint(x, null, tmpOut);
            } else {
              tmpIn[0] = data2.getByDimIdx(dimIdx0, i);
              tmpIn[1] = data2.getByDimIdx(dimIdx1, i);
...
var elementCreator = {
  ...
  polar: function(seriesModel, data, newIndex, layout8, isRadial, animationModel, axisModel, isUpdate, roundCap) {
    var clockwise = layout8.startAngle < layout8.endAngle;
...
function updateStyle(el, data, dataIndex, itemModel, layout8, seriesModel, isHorizontal, isPolar) {
  ...
  if (!isPolar) {
    var labelPositionOutside = isHorizontal ? layout8.height > 0 ? "bottom" : "top" : layout8.width > 0 ? "left" : "right";
...
var PiePiece = function(_super) {
  ...
  PiePiece2.prototype.updateData = function(data, idx, startAngle, firstCreate) {
    ...
    var sectorShape = extend(getSectorCornerRadius(itemModel.getModel("itemStyle"), layout8) || {}, layout8);
...
function createListSimply(seriesModel, opt, nameList) {
  ...
  var list = new List_default(dimensionsInfo, seriesModel);
...
var Tree = function() {
  ...
  Tree2.createTree = function(dataRoot, hostModel, beforeLink) {
    ...
    var list = new List_default(dimensionsInfo, hostModel);
...
function createGraphFromNodeEdge(nodes, edges, seriesModel, directed, beforeLink) {
  ...
  var edgeData = new List_default(["value"], seriesModel);
...
var GraphSeriesModel = function(_super) {
  ...
  GraphSeriesModel2.prototype._updateCategoriesData = function() {
    ...
    var categoriesData = new List_default(["value"], this);
      ...
      switch (curve.style.fill) {
        ...
        case "gradient":
          ...
          if (typeof sourceColor === "string" && typeof targetColor === "string") {
            curve.style.fill = new LinearGradient_default(0, 0, 1, 0, [{
              color: sourceColor,
              offset: 0
            }, {
              color: targetColor,
...
var EffectSymbol = function(_super) {
  ...
  EffectSymbol2.prototype.updateData = function(data, idx) {
    ...
    var symbolSize = normalizeSymbolSize2(data.getItemVisual(idx, "symbolSize"));
    var symbolStyle = data.getItemVisual(idx, "style");
    ...
    if (symbolOffset) {
      ...
      rippleGroup.x = parsePercent2(symbolOffset[0], symbolSize[0]);
      rippleGroup.y = parsePercent2(retrieve2(symbolOffset[1], symbolOffset[0]) || 0, symbolSize[1]);
    }
...
var LinesSeriesModel = function(_super) {
  ...
  LinesSeriesModel2.prototype.getInitialData = function(option, ecModel) {
    ...
    var lineData = new List_default(["value"], this);
...
var ThemeRiverSeriesModel = function(_super) {
  ...
  ThemeRiverSeriesModel2.prototype.getInitialData = function(option, ecModel) {
    ...
    var list = new List_default(dimensionsInfo, this);
    list.initData(data);
    return list;
  };
...
function morphPath(fromPath, toPath, animationOpts) {
  ...
  toPathProxy === fromPathProxy && (toPathProxy = new PathProxy_default(false));
...
function splitShape(path, separateCount) {
  ...
  if (path instanceof Rect_default) {
    ...
    for (var i = 0; i < separateCount; i++, xyCurr += subWH) {
      ...
      var splitted = new Rect_default({ shape: subShape });
      resultPaths.push(splitted);
    }
  } else if (path instanceof Sector_default) {
    var toPathShape = path.shape;
    ...
    for (var i = 0; i < separateCount; i++, angleCurr += step) {
      var splitted = new Sector_default({
        shape: {
          cx: toPathShape.cx,
          cy: toPathShape.cy,
          r: toPathShape.r,
...
function duplicateShape(path, separateCount) {
  ...
  for (var i = 0; i < separateCount; i++) {
    ...
    resultPaths.push(sub2);
  }
  return resultPaths;
}
function normalizeRadian(start, end, clockwise) {
  return end + PI23 * Math[clockwise ? "ceil" : "floor"]((start - end) / PI23);
}
...
var tmpTransformable = new Transformable_default();
var prepareCustoms = {
...
var CustomSeriesView = function(_super) {
  __extends(CustomSeriesView2, _super);
  function CustomSeriesView2() {
    var _this = _super !== null && _super.apply(this, arguments) || this;
    _this.type = CustomSeriesView2.type;
    return _this;
  }
  CustomSeriesView2.prototype.render = function(customSeries, ecModel, api, payload) {
    var oldData = this._data;
    ...
    if (transOpt && (transOpt.from == null || transOpt.to == null)) {
      ...
      new DataDiffer_default(oldData ? oldData.getIndices() : [], data.getIndices(), createGetKey(oldData, diffMode, transOpt && transOpt.from), createGetKey(data, diffMode, transOpt && transOpt.to), null, diffMode).add(function(newIdx) {
        createOrUpdateItem(api, null, newIdx, renderItem(newIdx, payload), customSeries, group, data, null);
      }).remove(function(oldIdx) {
        doRemoveEl(oldData.getItemGraphicEl(oldIdx), customSeries, group);
      }).update(function(newIdx, oldIdx) {
  ...
  CustomSeriesView2.prototype.incrementalPrepareRender = function(customSeries, ecModel, api) {
    this.group.removeAll();
    this._data = null;
  };
  CustomSeriesView2.prototype.incrementalRender = function(params, customSeries, ecModel, api, payload) {
    var data = customSeries.getData();
    var renderItem = makeRenderItem(customSeries, data, ecModel, api);
  ...
  CustomSeriesView2.prototype.filterForExposedEvent = function(eventType, query, targetEl, packedEvent) {
  ...
  CustomSeriesView2.type = "custom";
  return CustomSeriesView2;
}(Chart_default);
...
function createEl(elOption) {
  ...
  if (graphicType === "path") {
    ...
    inner4(el).customPathData = pathData;
  } else if (graphicType === "image") {
    el = new Image_default({});
    inner4(el).customImagePath = elOption.style.image;
  ...
  inner4(el).customGraphicType = graphicType;
...
function updateElNormal(api, el, isMorphTo, dataIndex, elOption, styleOpt, attachedTxInfo, seriesModel, isInit, isTextContent) {
  ...
  if (!isTextContent) {
    hasOwn(elOption, "info") && (inner4(el).info = elOption.info);
  }
...
function applyTransitionFrom(el, dataIndex, elOption, seriesModel, transFromProps, isInit) {
  if (transFromProps) {
    ...
    inner4(el).userDuring = userDuring;
...
function calcOldElLocalTransformBasedOnNewElParent(oldEl, newEl) {
  ...
  oldGlobalTransform ? copy2(tmpM, oldGlobalTransform) : identity(tmpM);
...
function duringCall() {
  ...
  var newstUserDuring = inner4(el).userDuring;
...
function doCreateOrUpdateEl(api, el, dataIndex, elOption, seriesModel, group, isRoot, morphPreparation) {
  ...
  var canMorph = inner4(el).canMorph = elOption.morph && isPath(el);
...
function doRemoveEl(el, seriesModel, group) {
  if (el) {
    var leaveToProps = inner4(el).leaveToProps;
...
function isPath(el) {
  return el && el instanceof Path_default;
}
function removeElementDirectly(el, group) {
  el && group.remove(el);
}
var MorphPreparation = function() {
  function MorphPreparation2(seriesModel, transOpt) {
    this._fromList = [];
    this._toList = [];
  ...
  MorphPreparation2.prototype.hasFrom = function() {
    return !!this._fromList.length;
  };
  MorphPreparation2.prototype.findAndAddFrom = function(el) {
    if (!el) {
      return;
    }
    if (inner4(el).canMorph) {
  ...
  MorphPreparation2.prototype.addTo = function(path, elOption, dataIndex, allPropsFinal) {
    if (path) {
  ...
  MorphPreparation2.prototype.applyMorphing = function() {
    var type = this._type;
  ...
  MorphPreparation2.prototype._oneToOneForSingleTo = function(toIdx, fromIdx) {
  ...
  MorphPreparation2.prototype._manyToOneForSingleTo = function(toIdx, fromIdxStart, fromCount) {
    var to = this._toList[toIdx];
    var toElOption = this._toElOptionList[toIdx];
    var allPropsFinal = this._allPropsFinalList[toIdx];
    applyPropsFinal(to, allPropsFinal, toElOption.style);
  ...
  MorphPreparation2.prototype._oneToManyForSingleFrom = function(toIdxStart, toCount, fromIdx) {
  ...
  MorphPreparation2.prototype._processResultIndividuals = function(combineSeparateResult, toIdxStart, toCount) {
  ...
  MorphPreparation2.prototype._getOrCreateMorphConfig = function(dataIndex) {
  ...
  MorphPreparation2.prototype.reset = function(type) {
    this._type = type;
