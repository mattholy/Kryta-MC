...
// node_modules/pinia/node_modules/@vue/devtools-api/lib/esm/api/index.js
init_define_APP_INFO();

// node_modules/pinia/node_modules/@vue/devtools-api/lib/esm/api/api.js
init_define_APP_INFO();

// node_modules/pinia/node_modules/@vue/devtools-api/lib/esm/api/app.js
init_define_APP_INFO();

// node_modules/pinia/node_modules/@vue/devtools-api/lib/esm/api/component.js
init_define_APP_INFO();

// node_modules/pinia/node_modules/@vue/devtools-api/lib/esm/api/context.js
init_define_APP_INFO();

// node_modules/pinia/node_modules/@vue/devtools-api/lib/esm/api/hooks.js
init_define_APP_INFO();

// node_modules/pinia/node_modules/@vue/devtools-api/lib/esm/api/util.js
init_define_APP_INFO();
...
function createOptionsStore(id, options, pinia, hot) {
  ...
  function setup() {
    ...
    const localState = hot ? toRefs(ref(state ? state() : {}).value) : initialState || toRefs(pinia.state.value[id]);
...
function defineStore(idOrOptions, setup, setupOptions) {
  ...
  function useStore(pinia, hot) {
    ...
    if (!pinia._s.has(id)) {
      pinia._s.set(id, isSetupStore ? createSetupStore(id, setup, options, pinia) : createOptionsStore(id, options, pinia));
      if (true) {
...
function createTestingPinia({ plugins = [], stubActions = true, stubPatch = false, fakeApp = false, createSpy } = {}) {
  ...
  createSpy = createSpy || typeof jest !== void 0 && jest.fn;
  if (!createSpy) {
  ...
  pinia.use(({ store, options }) => {
    ...
    Object.keys(options.actions || {}).forEach((action) => {
      actionsCache[action] = actionsCache[action] || (stubActions ? createSpy() : createSpy(store[action]));
