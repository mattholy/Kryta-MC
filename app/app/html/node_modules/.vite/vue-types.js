...
function k(e, t2 = "custom validation failed") {
  ...
  return j(e.name || "<<anonymous function>>", { validator(r2) {
    const n2 = e(r2);
...
var vue_types_modern_default = z;

// dep:vue-types
var vue_types_default = vue_types_modern_default;
export {
  w as any,
  q as array,
  F as arrayOf,
