import {
  ...
  trim,
  windingLine
} from "./chunk-QB253RHB.js";
import {
  __export,
  init_define_APP_INFO
} from "./chunk-PTONCET3.js";
...
var SeriesModel = function(_super) {
  ...
  SeriesModel2.prototype.getSource = function() {
    return inner2(this).sourceManager.getSource();
  };
...
var GlobalModel = function(_super) {
  ...
  GlobalModel2.prototype.getLocale = function(localePosition) {
...
var ECharts = function(_super) {
  ...
  function ECharts2(dom, theme2, opts) {
    ...
    _this._labelManager = new LabelManager_default();
    _this._initEvents();
  ...
  ECharts2.prototype.getDataURL = function(opts) {
    ...
    var self = this;
    each4(excludeComponents, function(componentType) {
      ecModel.eachComponent({
    ...
    each4(excludesComponentViews, function(view) {
  ...
  ECharts2.prototype.getConnectedDataURL = function(opts) {
    ...
    if (connectedGroups[groupId]) {
      ...
      if (isSvg) {
        var content_1 = "";
        each4(canvasList_1, function(item) {
  ...
  ECharts2.prototype._initEvents = function() {
    var _this = this;
    each4(MOUSE_EVENT_NAMES, function(eveName) {
    ...
    each4(eventActionMap, function(actionType, eventType) {
      _this._messageCenter.on(eventType, function(event) {
        this.trigger(eventType, event);
      }, _this);
    });
    each4(["selectchanged"], function(eventType) {
      _this._messageCenter.on(eventType, function(event) {
        this.trigger(eventType, event);
      }, _this);
    });
  ...
  ECharts2.prototype.dispose = function() {
    ...
    var api = this._api;
    var ecModel = this._model;
    each4(this._componentsViews, function(component) {
      component.dispose(ecModel, api);
    });
    each4(this._chartsViews, function(chart) {
  ...
  ECharts2.internalField = function() {
    ...
    updateDirectly = function(ecIns, method, payload, mainType, subType) {
      ...
      if (!mainType) {
        each4([].concat(ecIns._componentsViews).concat(ecIns._chartsViews), callView);
        return;
      }
      var query = {};
      ...
      if (excludeSeriesId != null) {
        ...
        each4(normalizeToArray(excludeSeriesId), function(id) {
        ...
        if (!excludeSeriesIdMap || excludeSeriesIdMap.get(model.id) == null) {
          if (isHighDownPayload(payload)) {
            if (model instanceof Series_default) {
              ...
              if (dispatchers) {
                each4(dispatchers, function(dispatcher) {
    ...
    doDispatchAction = function(payload, silent) {
      ...
      each4(payloads, function(batchItem) {
    ...
    render = function(ecIns, ecModel, api, payload) {
      ...
      each4(ecIns._chartsViews, function(chart) {
        chart.__alive = false;
      });
    ...
    renderComponents = function(ecIns, ecModel, api, payload, dirtyList) {
      each4(dirtyList || ecIns._componentsViews, function(componentView) {
    ...
    performPostUpdateFuncs = function(ecModel, api) {
      each4(postUpdateFuncs, function(func) {
        func(ecModel, api);
      });
    };
      ...
      each4(eventActionMap, function(actionType, eventType) {
        chart._messageCenter.on(eventType, function(event) {
          if (connectedGroups[chart.group] && chart[CONNECT_STATUS_KEY] !== CONNECT_STATUS_PENDING) {
            ...
            var otherCharts_1 = [];
            each4(instances2, function(otherChart) {
              if (otherChart !== chart && otherChart.group === chart.group) {
                otherCharts_1.push(otherChart);
              }
            });
            updateConnectedChartsStatus(otherCharts_1, CONNECT_STATUS_PENDING);
            each4(otherCharts_1, function(otherChart) {
...
function init2(dom, theme2, opts) {
  ...
  enableConnect(chart);
  each4(postInitFuncs, function(postInitFunc) {
    postInitFunc(chart);
  });
  return chart;
}
...
function registerPostInit(postInitFunc) {
  if (indexOf2(postInitFuncs, postInitFunc) < 0) {
    postInitFunc && postInitFuncs.push(postInitFunc);
  }
}
function registerPostUpdate(postUpdateFunc) {
  if (indexOf2(postUpdateFuncs, postUpdateFunc) < 0) {
...
function registerAction(actionInfo, eventName, action) {
  ...
  var actionType = isObject3(actionInfo) ? actionInfo.type : [actionInfo, actionInfo = {
    event: eventName
  }][0];
...
function normalizeRegister(targetList, priority, fn, defaultPriority, visualType) {
  ...
  if (true) {
    ...
    each4(targetList, function(wrap) {
...
var DataDimensionInfo = function() {
  ...
  return DataDimensionInfo2;
}();
var DataDimensionInfo_default = DataDimensionInfo;
...
var List = function() {
  function List2(dimensions, hostModel) {
    this.type = "list";
    this._count = 0;
    this._rawCount = 0;
    this._storage = {};
    ...
    for (var i = 0; i < dimensions.length; i++) {
      ...
      var dimensionInfo = isString(dimInfoInput) ? new DataDimensionInfo_default({
        name: dimInfoInput
  ...
  List2.prototype.getDimension = function(dim) {
    if (typeof dim === "number" || !isNaN(dim) && !this._dimensionInfos.hasOwnProperty(dim)) {
      dim = this.dimensions[dim];
    }
    return dim;
  };
  List2.prototype.getDimensionInfo = function(dim) {
    return this._dimensionInfos[this.getDimension(dim)];
  };
  List2.prototype.getDimensionsOnCoord = function() {
    return this._dimensionsSummary.dataDimsOnCoord.slice();
  };
  List2.prototype.mapDimension = function(coordDim, idx) {
  ...
  List2.prototype.mapDimensionsAll = function(coordDim) {
    var dimensionsSummary = this._dimensionsSummary;
    var dims = dimensionsSummary.encode[coordDim];
    return (dims || []).slice();
  };
  List2.prototype.initData = function(data, nameList, dimValueGetter) {
  ...
  List2.prototype.getProvider = function() {
    return this._rawData;
  };
  List2.prototype.appendData = function(data) {
    if (true) {
  ...
  List2.prototype.appendValues = function(values, names) {
    ...
    for (var i = 0; i < dimLen; i++) {
      ...
      prepareStorage(storage2, this._dimensionInfos[dim], end, true);
    }
    var rawExtentArr = map2(dimensions, function(dim2) {
      return rawExtent[dim2];
    });
    var storageArr = this._storageArr = map2(dimensions, function(dim2) {
      return storage2[dim2];
    });
    var emptyDataItem = [];
  ...
  List2.prototype._initDataFromProvider = function(start, end, append) {
    if (start >= end) {
      return;
    }
    var rawData = this._rawData;
    ...
    for (var i = 0; i < dimLen; i++) {
      ...
      prepareStorage(storage2, dimensionInfoMap[dim], end, append);
    }
    var storageArr = this._storageArr = map2(dimensions, function(dim2) {
      return storage2[dim2];
    });
  ...
  List2.prototype.count = function() {
    return this._count;
  };
  List2.prototype.getIndices = function() {
    var newIndices;
  ...
  List2.prototype.getByDimIdx = function(dimIdx, idx) {
  ...
  List2.prototype.get = function(dim, idx) {
    if (!(idx >= 0 && idx < this._count)) {
      return NaN;
    }
  ...
  List2.prototype.getByRawIndex = function(dim, rawIdx) {
  ...
  List2.prototype.getValues = function(dimensions, idx) {
    var values = [];
  ...
  List2.prototype.hasValue = function(idx) {
  ...
  List2.prototype.getDataExtent = function(dim) {
  ...
  List2.prototype.getApproximateExtent = function(dim) {
    dim = this.getDimension(dim);
    return this._approximateExtent[dim] || this.getDataExtent(dim);
  };
  List2.prototype.setApproximateExtent = function(extent3, dim) {
    dim = this.getDimension(dim);
    this._approximateExtent[dim] = extent3.slice();
  };
  List2.prototype.getCalculationInfo = function(key) {
    return this._calculationInfo[key];
  };
  List2.prototype.setCalculationInfo = function(key, value) {
    isObject4(key) ? extend(this._calculationInfo, key) : this._calculationInfo[key] = value;
  };
  List2.prototype.getSum = function(dim) {
    var dimData = this._storage[dim];
    var sum = 0;
    if (dimData) {
  ...
  List2.prototype.getMedian = function(dim) {
    var dimDataArray = [];
  ...
  List2.prototype.rawIndexOf = function(dim, value) {
  ...
  List2.prototype.indexOfName = function(name) {
    for (var i = 0, len = this.count(); i < len; i++) {
  ...
  List2.prototype.indexOfRawIndex = function(rawIndex) {
  ...
  List2.prototype.indicesOfNearest = function(dim, value, maxDistance) {
    var storage2 = this._storage;
  ...
  List2.prototype.getRawDataItem = function(idx) {
  ...
  List2.prototype.getName = function(idx) {
  ...
  List2.prototype.getId = function(idx) {
    return getId(this, this.getRawIndex(idx));
  };
  List2.prototype.each = function(dims, cb, ctx, ctxCompat) {
    "use strict";
    var _this = this;
    if (!this._count) {
      return;
    ...
    var dimNames = map2(normalizeDimensions(dims), this.getDimension, this);
    if (true) {
      validateDimensions(this, dimNames);
    }
    var dimSize = dimNames.length;
    var dimIndices = map2(dimNames, function(dimName) {
  ...
  List2.prototype.filterSelf = function(dims, cb, ctx, ctxCompat) {
    "use strict";
    var _this = this;
    if (!this._count) {
      return;
  ...
  List2.prototype.selectRange = function(range) {
    "use strict";
    var _this = this;
    var len = this._count;
    if (!len) {
    ...
    var dimIndices = map2(dimensions, function(dimName) {
      return _this._dimensionInfos[dimName].index;
    });
  ...
  List2.prototype.mapArray = function(dims, cb, ctx, ctxCompat) {
    "use strict";
    if (typeof dims === "function") {
      ctxCompat = ctx;
      ctx = cb;
  ...
  List2.prototype.map = function(dims, cb, ctx, ctxCompat) {
    "use strict";
    var fCtx = ctx || ctxCompat || this;
    var dimNames = map2(normalizeDimensions(dims), this.getDimension, this);
    if (true) {
  ...
  List2.prototype.downSample = function(dimension, rate, sampleValue, sampleIndex) {
  ...
  List2.prototype.lttbDownSample = function(valueDimension, rate) {
  ...
  List2.prototype.getVisual = function(key) {
    var visual = this._visual;
    return visual && visual[key];
  };
  List2.prototype.setVisual = function(kvObj, val) {
  ...
  List2.prototype.getItemVisual = function(idx, key) {
  ...
  List2.prototype.hasItemVisual = function() {
    return this._itemVisuals.length > 0;
  };
  List2.prototype.ensureUniqueItemVisual = function(idx, key) {
  ...
  List2.prototype.setItemVisual = function(idx, key, value) {
    var itemVisual = this._itemVisuals[idx] || {};
  ...
  List2.prototype.clearAllVisual = function() {
    this._visual = {};
    this._itemVisuals = [];
  };
  List2.prototype.setLayout = function(key, val) {
    if (isObject4(key)) {
  ...
  List2.prototype.getLayout = function(key) {
    return this._layout[key];
  };
  List2.prototype.getItemLayout = function(idx) {
    return this._itemLayouts[idx];
  };
  List2.prototype.setItemLayout = function(idx, layout3, merge2) {
    this._itemLayouts[idx] = merge2 ? extend(this._itemLayouts[idx] || {}, layout3) : layout3;
  };
  List2.prototype.clearItemLayouts = function() {
    this._itemLayouts.length = 0;
  };
  List2.prototype.setItemGraphicEl = function(idx, el) {
    var hostModel = this.hostModel;
    if (el) {
      var ecData = getECData(el);
  ...
  List2.prototype.getItemGraphicEl = function(idx) {
    return this._graphicEls[idx];
  };
  List2.prototype.eachItemGraphicEl = function(cb, context) {
  ...
  List2.prototype.cloneShallow = function(list) {
    if (!list) {
      var dimensionInfoList = map2(this.dimensions, this.getDimensionInfo, this);
      list = new List2(dimensionInfoList, this.hostModel);
    }
  ...
  List2.prototype.wrapMethod = function(methodName, injectFunction) {
  ...
  List2.internalField = function() {
    ...
    prepareStorage = function(storage2, dimInfo, end, append) {
      var DataCtor = dataCtors[dimInfo.type];
      var dim = dimInfo.name;
      if (append) {
        var oldStore = storage2[dim];
        ...
        if (!(oldLen === end)) {
          ...
          storage2[dim] = newStore;
        }
      } else {
        storage2[dim] = new DataCtor(end);
      }
    };
    ...
    cloneListForMapAndSample = function(original, excludeDimensions) {
      ...
      var list = new List2(map2(allDimensions, original.getDimensionInfo, original), original.hostModel);
      ...
      for (var i = 0; i < allDimensions.length; i++) {
        ...
        if (originalStorage[dim]) {
          if (indexOf(excludeDimensions, dim) >= 0) {
            storage2[dim] = cloneChunk(originalStorage[dim]);
            list._rawExtent[dim] = getInitialExtent();
            list._extent[dim] = null;
          } else {
            storage2[dim] = originalStorage[dim];
          }
          storageArr.push(storage2[dim]);
        }
      }
      return list;
    };
...
var LogScale = function(_super) {
  ...
  LogScale2.prototype.niceTicks = function(approxTickNum) {
    ...
    var niceExtent = [round2(mathCeil(extent3[0] / interval) * interval), round2(mathFloor2(extent3[1] / interval) * interval)];
    this._interval = interval;
...
function niceScaleExtent(scale4, model) {
...
function getListCache(axis, prop) {
  return inner5(axis)[prop] || (inner5(axis)[prop] = []);
}
...
function makeAutoCategoryInterval(axis) {
  var result = inner5(axis).autoInterval;
  return result != null ? result : inner5(axis).autoInterval = axis.calculateCategoryInterval();
}
...
***************************************************************************** */
//# sourceMappingURL=chunk-33T4HP3P.js.map
