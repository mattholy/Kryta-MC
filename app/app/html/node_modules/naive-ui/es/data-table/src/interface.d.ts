...
export declare type Sorter<T = InternalRowData> = (row1: T, row2: T) => number;
...
export declare type TableColumn<T = InternalRowData> = TableColumnGroup | TableBaseColumn<T> | TableSelectionColumn<T> | TableExpandColumn<T>;
