...
declare const _default: import("vue").DefineComponent<{
    ...
    fixedColumnLeftMap: import("vue").Ref<Record<import("../interface").ColumnKey, number | undefined>>;
    fixedColumnRightMap: import("vue").Ref<Record<import("../interface").ColumnKey, number | undefined>>;
    ...
    mergedExpandedRowKeys: import("vue").Ref<RowKey[]>;
    hoverKey: import("vue").Ref<RowKey | null>;
    mergedSortState: import("vue").Ref<import("../interface").SortState | null>;
    ...
    handleUpdateExpanded: (key: RowKey) => void;
